...
caidas en tres regiones importantes del pais. Determina tambien
...
void main(void)
{
    ...
    printf("\nPromedio de lluvias Region Pcifico: %6.2f", (APAC / 12));
    printf("\nPromedio de lluvias Region Caribe: %6.2f \n",(ACAR / 12));
    Mayor(AGOL, APAC, ACAR);
    /* Se llama a l afuncion Mayor. Paso de parametros por valor. */
