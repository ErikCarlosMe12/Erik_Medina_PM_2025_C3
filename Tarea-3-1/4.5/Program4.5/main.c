...
/* Cubo-3.
El programa calcula el cubo de los 10 primeros numero naturales
con la ayuda de una funcion y utlizando parametros por valor. */
...
/* L afuncion calcula el cubo del parametro K. */
{
    return (K*K*K);
}
