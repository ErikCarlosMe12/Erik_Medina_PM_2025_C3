...
int main(void)
{
    ...
    scanf("%d", &N);
    } while (N > MAX || N < 1); /* Verifica que el tamaño sea valido. */
...
/* Lee un arreglo bidimensional cuadrado de T x T. */
...
/* Regresa 1 si la matriz es simetrica, 0 en caso contrario. */
{
    int I = 0, J, F = 1;
