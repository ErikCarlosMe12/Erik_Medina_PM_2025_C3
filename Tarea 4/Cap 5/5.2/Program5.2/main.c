...
/* Eleccion.
El programa almacena los votos emitidos en una eleccion en la hubo
cinco candidatos e imprime el total de votos que obtuvo cada uno
de ellos. */

void main(void)
{
    int ELE[5] = {0}; /* Declaracion del arreglo entero ELE de cinco
    elementos. Todos sus elementos se incializan  en 0. */
    int I, VOT;
