...
/* Estadistico.
El programa, al recibir como dato un arreglo unidimensional de entero
que contiene calificaciones, calcula la media, la varianza, la desviacion
estandar y la moda. */
...
/* Esta funcionn se utiliza para calcular la varianza. */
