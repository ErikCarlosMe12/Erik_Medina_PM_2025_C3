...
El program, al recibir como dato N lanzamaiento de martillo, calcula el promedio de los lanzaminetos de la atleta cubana.
...
SLA = SLA / N;
printf("\nEl promedio de lanzaminetos es: %.2f", SLA);
}
